---
title: "Roadmap"
description: "This page outlines the roadmap for Twelve Labs Video Understanding API."
---

Note that Twelve Labs is continuously adding new features based on customer feedback. As a result, this roadmap is not exhaustive and is subject to change.
