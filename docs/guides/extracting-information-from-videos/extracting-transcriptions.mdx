...
const VIDEO_VECTOR_ID_URL \= \`${API\_URL}/indexes/tasks/${TASK_ID}/video-id\`
...
const TRANSCRIPTIONS_URL \= \`${API\_URL}/indexes/${INDEX_ID}/videos/${VIDEO_ID}/transcription\`
...
const TRANSCRIPTIONS_URL \= \`${API\_URL}/indexes/${INDEX_ID}/videos/${VIDEO_ID}/transcription?start=300&end=320\`
