...
* Retrieve the transcription. Use the [indexes/:index-id/videos/:video-id/transcription](/reference/api-reference/indexes-videos#retrieve-a-transcription) endpoint passing it the unique identifiers of your index and video vector.
...
TRANSCRIPTIONS\_URL \= f"{API\_URL}/indexes/{INDEX\_ID}/videos/{VIDEO\_ID}/transcription"

const TRANSCRIPTIONS\_URL \= \`${API\_URL}/indexes/${INDEX\_ID}/videos/${VIDEO\_ID}/transcription\`
...
response \= requests.get(TRANSCRIPTIONS\_URL, headers\=headers)
...
{'\_id': '62aff6da154f59c87660ce9a',
 ...
 'type': 'video\_index\_meta\_transcription'}
...
TRANSCRIPTIONS\_URL \= f"{API\_URL}/indexes/{INDEX\_ID}/videos/{VIDEO\_ID}/transcription?start=300&end=320"

const TRANSCRIPTIONS\_URL \= \`${API\_URL}/indexes/${INDEX\_ID}/videos/${VIDEO\_ID}/transcription?start=300&end=320\`
