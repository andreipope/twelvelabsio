...
VIDEO\_VECTOR\_ID\_URL \= f"{API\_URL}/indexes/tasks/{TASK\_ID}/video-id"

const VIDEO\_VECTOR\_ID\_URL \= \`${API\_URL}/indexes/tasks/${TASK\_ID}/video-id\`
...
response \= requests.get(VIDEO\_VECTOR\_ID\_URL, headers\=headers)

VIDEO\_ID \= response.json().get("\_id")

print (f"Status code: {response.status\_code}")

pprint (response.json())

print(f"Task ID {TASK\_ID} \-> Video ID {VIDEO\_ID}")

let config \= {

method: 'get',

url: VIDEO\_VECTOR\_ID\_URL,
...
const VIDEO\_ID \= response.\_id

console.log(\`Status code: ${resp.status}\`)

console.log(response)

console.log(\`Task ID ${TASK\_ID} \-> Video ID ${VIDEO\_ID}\`)
...
TEXT\_IN\_VIDEO\_URL \= f"{API\_URL}/indexes/{INDEX\_ID}/videos/{VIDEO\_ID}/text\-in\-video

const TEXT\_IN\_VIDEO\_URL \= \`${API\_URL}/indexes/${INDEX\_ID}/videos/${VIDEO\_ID}/text\-in\-video
...
response \= requests.get(TEXT\_IN\_VIDEO\_URL, headers\=headers)
...
{'\_id': '62aeb771154f59c87660ce91',
 ...
 'type': 'video\_index\_meta\_text\_in\_video'}
...
TEXT\_IN\_VIDEO\_URL \= f"{API\_URL}/indexes/{INDEX\_ID}/videos/{VIDEO\_ID}/text-in-video?start=0&end=10"

const TEXT\_IN\_VIDEO\_URL \= \`${API\_URL}/indexes/${INDEX\_ID}/videos/${VIDEO\_ID}/text-in-video?start=0&end=10\`
