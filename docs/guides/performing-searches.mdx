...
This section provides examples demonstrating how to perform searches. The API allows you to perform the following type of searches by specifying the [search\_options](/concepts/search-options) parameter in the body of the request:
...
**NOTE**: The search options you specify must be a subset of the [indexing options](/concepts/indexing-options) used when you [created the index](/reference/api-reference/indexes-tasks#create-a-new-video-indexing-task).
