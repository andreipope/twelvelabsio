...
5\. _(Optional)_ You can use the [tasks/{\_id}](/reference/api-reference/indexes-tasks#get-the-status-info-of-the-video-index-task.) endpoint to monitor the indexing process. Wait until the status shows as `ready`:
