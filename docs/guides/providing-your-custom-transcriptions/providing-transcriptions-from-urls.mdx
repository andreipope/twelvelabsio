...
In this guide you'll learn how to upload a video file and provide a
transcription when both files are available from public URLs. The API service
will download the files directly from the specified URLs, so your application
doesn't have to store them locally and upload the bytes.
...
2. To provide a transcription file, you must set the `provide_transcription`
   ...
   the URLs of your video and transcription file.
...
4. _(Optional)_ You can use the
