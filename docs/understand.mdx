---
title: "Understand"
description: "Twelve Labs Video Understanding API is a cloud-based, AI-powered video search
service offering full natural language-based search."
---
...
1. Create an index, specifying the name, indexing options, and the engine.
   The API creates a unique identifier for each index.

2. Upload a video, specifying the unique identifier of the index with which
...
3. Perform a search by providing your search terms and the unique identifier
