...
- **Query Parameters**: Any parameters that an endpoint accepts. For example, you can [filter](/concepts/filtering) or [sort](/concepts/sorting) a response using query parameters.
